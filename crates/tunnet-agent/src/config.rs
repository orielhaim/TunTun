...
#[command(
    name = "tunnet-agent",
    about = "Tunnet agent - binds a TUN device and an iroh endpoint"
)]
pub struct Config {
    #[arg(
        long,
    ...
    #[arg(long, env = "TUNNET_TOKEN", default_value = "dev-token")]
    pub token: String,

    /// Network name to join.
    #[arg(long, env = "TUNNET_NETWORK", default_value = "default")]
    pub network: String,
    ...
    #[arg(long, env = "TUNNET_POLL_SECS", default_value_t = 10)]
    pub poll_secs: u64,
