...
use iroh::EndpointId;
use tokio::sync::mpsc;
use tuntun_common::policy::Selector;
use tuntun_common::recording::{
    RecordingMeta, asciinema_header_line, asciinema_output_event, asciinema_resize_event,
};
use tuntun_common::ssh::SshResponseHeader;
use tuntun_core::recording::dial_recording;
use tuntun_core::{AclEngine, ConnPool, RoutingTable};
...
pub fn recorder_unavailable(enforce: bool) -> SshResponseHeader {
    if enforce {
        SshResponseHeader {
            status: tuntun_common::ssh::SshStatus::RecorderUnavailable as u8,
            reauth_url: None,
