...
referencing this Agreement that specifies the license tier,
fees, term, and any additional terms.

"Internal Use" means use of the Software by the Licensee and
its employees and contractors solely for the Licensee's own
business operations. Internal Use does not include offering the
Software to third parties as a hosted or managed service.

"OEM Use" means distribution of the Software, or a product
incorporating the Software, to third parties, whether as
source code, compiled code, or a hosted service.
...
indicated in the Order Form:
  ...
  (b) OEM / RESALE LICENSE - Licensee may incorporate the
      ...
      under the AGPL. Redistribution terms, sublicensing
      scope, and any per-seat or per-node limits are specified
      in the Order Form.
...
3.1 Licensee shall pay the fees stated in the Order Form.
Unless the Order Form says otherwise, fees are due within
...
4.1 This Agreement begins on the effective date in the Order
Form and continues for the term specified there. It renews
...
4.2 Either party may terminate this Agreement if the other
...
under this commercial license. Licensee may continue to use
the Software under the AGPL v3 if it complies fully with
those terms. Sections 5, 6, 7, and 8 survive termination.
...
8.1 This Agreement and the Order Form constitute the entire
agreement between the parties regarding its subject matter.

8.2 This Agreement is governed by the laws of [JURISDICTION],
...
8.5 If any provision is held unenforceable, the remaining
provisions continue in full force.

8.6 Failure to enforce a right is not a waiver of that right.
