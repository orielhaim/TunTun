...
For example, you might expose a database admin panel with `tuntun serve 8080` but restrict access to machines tagged `dba`. Only peers matching the ACL can establish a stream to the serve.
